# -*- coding: utf-8 -*-
"""
UPDATED & FIXED: TFT MegaCap5 full fiscal year (h=4) multi-horizon hybrid model.
Fixed KeyError: 'time_idx' by explicitly attaching index in _load_all.
Output format matched to tft_baseline_h4.
...
OUT_DIR   = r"C:\ThesisResearch\finbert_tft\results\TFT_MegaCap5_h4_epoch150_L4"
...
def _load_all(data_dir: str) -> pd.DataFrame:
    ...
    data = data[data["ticker"].isin(MEGA_CAP_5)].copy()
